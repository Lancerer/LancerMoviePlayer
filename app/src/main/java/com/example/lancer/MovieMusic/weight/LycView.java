...
import com.example.lancer.MovieMusic.util.DensityUtil;
...
import com.example.lancer.MovieMusic.bean.LyricBean;
...
public class LycView extends TextView {
     ...
     * @param lyrics
     */
    public void setLyrics(ArrayList<LyricBean> lyrics) {
        this.lyrics = lyrics;
    }
    ...
    public LycView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        ...
        LogUtils.e("textHeight=="+textHeight);
        //创建画笔
        paint = new Paint();
