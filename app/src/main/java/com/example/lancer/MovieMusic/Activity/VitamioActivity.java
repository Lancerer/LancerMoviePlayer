...
import com.example.lancer.MovieMusic.weight.VitamioVideoView;
...
public class VitamioActivity extends AppCompatActivity implements View.OnClickListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnCompletionListener, SeekBar.OnSeekBarChangeListener {
    /*
    * 视频进度更新
    * */
...
/*    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Vitamio.isInitialized(this);//todo 初始化vitamio库
    ...
    public void onPrepared(MediaPlayer mp) {
        ...
        tvVideocontrollerEndTime.setText(MyUtils.parseTime((int) vv.getDuration()));
